...
export function renderPlayerCaddyInstructions({ hostname, ports, upstream = 'frontend:8080' }) {
  ...
  if (selectedPorts.length !== 6) throw new Error('Expected six player ports')
...
if (process.argv[1] && pathToFileURL(resolve(process.argv[1])).href === import.meta.url) {
  ...
  try {
    ...
    console.error(`Usage: node deploy/print-player-caddy.mjs HOSTNAME PORT1,PORT2,PORT3,PORT4,PORT5,PORT6 [UPSTREAM]\n${error.message}`)
    process.exitCode = 1
  }
}
