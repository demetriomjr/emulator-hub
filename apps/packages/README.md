...
`game-patches.mjs` resolves and verifies optional IPS patches by trusted ROM SHA-256 using the data-only `assets/ips/manifest.json` registry. Patch matching and IPS format validation are independent of game IDs, titles, and systems.
