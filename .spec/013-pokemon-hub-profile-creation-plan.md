...
- Grid: uses 5–20 columns, provides a horizontal-scroll minimum width of five cards, and derives 60 initial slots plus a complete empty final row without persisting layout state.
